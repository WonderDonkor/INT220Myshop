      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="images/wonder's fashion.png" alt="wonder's fashion logotype" width="237" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="categories">
            ...
            <li class="categories__item">
              <a class="categories__link" href="shop3.php">
                Mens
            ...
            <li class="categories__item">
              <a class="categories__link" href="shop2.php">
                Womens
